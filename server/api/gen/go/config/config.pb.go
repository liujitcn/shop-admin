...
const file_config_config_proto_rawDesc = "" +
	...
	"\rConfigService\x12O\n" +
	"\tGetConfig\x12\x15.config.ConfigRequest\x1a\x16.config.ConfigResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/api/configB\x8a\x01\n" +
	"\n" +
	"com.configB\vConfigProtoP\x01Z7github.com/liujitcn/shop-admin/server/api/gen/go/config\xa2\x02\x03CXX\xaa\x02\x06Config\xca\x02\x06Config\xe2\x02\x12Config\\GPBMetadata\xea\x02\x06Configb\x06proto3"
